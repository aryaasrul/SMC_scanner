...
# --- Filter "Whale Screening" (BARU) ---
# Sesuai gambar: Cari volume besar, tapi skip coin raksasa
ENABLE_WHALE_FILTER = True
TOP_VOLUME_COUNT = 30         # Ambil 30 koin dengan volume terbesar
SKIP_TOP_MARKETCAP = [        # Daftar koin "berat" yang mau di-skip (Step 1 Image)
...
TARGET_LEVELS = [2, 3, 4, 5]  # R multiples untuk target
...
# --- Performance ---
SCAN_DELAY_SECONDS = 0.5      # Delay antar request (avoid rate limit)
ENABLE_CACHE = True           # Cache data untuk speed up

# --- Loop & Automation Setting ---
SCAN_INTERVAL_MINUTES = 30     # Bot akan scan tiap 60 menit
...
FILTERS = {
    'require_fvg_or_ob': False,        # Setup harus punya FVG ATAU OB
    'require_liquidity_sweep': False,   # Harus ada sweep sebelum entry
